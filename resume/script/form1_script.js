...
document.getElementById("edit").onclick= function()
{
    ...
    a = Math.round(Math.random()*256);
    b = Math.round(Math.random()*256);
    c = Math.round(Math.random()*256);
    var color1 = 'rgb('+x+','+y+','+z+')';
    var color2= 'rgb('+a+','+b+','+c+')';
    for(var i=0;i<document.getElementsByClassName('background1').length;i++) {
        document.getElementsByClassName('background1')[i].style.backgroundColor = color1;
    }
    for(var i=0;i<document.getElementsByClassName('background2').length;i++) {
        document.getElementsByClassName('background2')[i].style.backgroundColor = color2;
    }
}
